...
presentaron anteriormente de manera genérica.
...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{|c|X|}
        ...
        \hline
    \end{tabularx}
    \captionof{table}{RQF-1, requisito funcional 1: contenidos}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{|c|X|}
        ...
        Descripción & El sitio generado deberá ser completamente fiable
...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{|c|X|}
        ...
        posible, de forma que cualquier usuario lo pueda adaptar lo máximo posible 
        a sus necesidades.\\
...
El sistema contará con un motor de plantillas que permitirá al usuario definir y extenderlas de forma que pueda reutilizar
prácticamente todo el código HTML que genere para las propias plantillas de su sitio. Las alternativas barajadas son:
...
Finalmente se decidió usar \textbf{Jinja} por ser el sistema de plantilla más robusto y con mayor número de utilidades.
