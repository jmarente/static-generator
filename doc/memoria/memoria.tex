...
\newminted{python}{}
\newminted{json}{frame=bottomline,framerule=0.6pt}
\newminted{markdown}{}
...
% Agradecimientos
\input{0_inicio/agradecimientos.tex}
\cleardoublepage

% Resumen
\input{0_inicio/resumen.tex}
\cleardoublepage
...
\input{1_introduccion/contenido.tex}

\chapter{Planificación}
\label{chap:calendario}
\input{2_calendario/contenido.tex}

\chapter{Requisitos del sistema}
\label{chap:requisitos}
\input{3_requisitos/contenido.tex}

\chapter{Análisis}
\label{chap:analisis}
\input{4_analisis/contenido.tex}

\chapter{Diseño}
\label{chap:diseno}
\input{5_diseno/contenido.tex}

\chapter{Implementación}
\label{chap:implementacion}
\input{6_implementacion/contenido.tex}

\chapter{Pruebas}
\label{chap:pruebas}
\input{7_pruebas/contenido.tex}

\chapter{Conclusiones}
\label{chap:conclusiones}
\input{8_conclusiones/contenido.tex}

\appendix

\chapter{Manual de instalación}
\label{chap:manual_instalacion}
\input{A1_manual_instalacion/contenido.tex}

\chapter{Manual de usuario}
\label{chap:manual_usuario}
\input{A2_manual_usuario/contenido.tex}
